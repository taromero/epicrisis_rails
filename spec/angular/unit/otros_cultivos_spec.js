describe('Otros cultivos de una infeccion', function() {
    ...
    describe('when adding a new cultivo', function() {
        beforeEach(function() {
        ...
        it('should set focus to the name field', function() {
            ...
            var aux = document.activeElement;
            expect(aux.placeholder).toEqual('Nombre')
            template.remove();
        });


        describe('when name is blank and try to create the cultivo', function() {
            beforeEach(function() {
